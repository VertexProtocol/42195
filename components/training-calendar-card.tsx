    ...
    <AppCard className="space-y-3">
      ...
      <div className="grid grid-cols-7 gap-1">
        {visibleDays.map((d) => {
              ...
              <div className="flex-1 flex flex-col items-center justify-center gap-0.5">
                {hasGoal && (
                  <Flag
                    ...
                    size={14}
                    className="fill-amber-600 text-amber-600 dark:fill-sky-400 dark:text-sky-400"
                  />
                )}
                {hasData && (
          ...
          } ${isSelected ? "ring-2 ring-amber-500 dark:ring-sky-400" : ""}`
          if (hasGoal) {
            return (
              <button
                key={d.key}
          ...
          {selectedGoals.map((g) => {
            const row = (
              <>
                <Flag
                  size={11}
                  className="fill-amber-600 text-amber-600 dark:fill-sky-400 dark:text-sky-400 shrink-0"
                />
