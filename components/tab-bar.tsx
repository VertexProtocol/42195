...
import { Home, Activity, Target, BookOpen, User, Sparkles } from "lucide-react"
...
const tabs: { id: TabId; labelKey: "tab.home" | "tab.activities" | "tab.goals" | "tab.plan" | "tab.coach" | "tab.profile"; icon: typeof Home }[] = [
