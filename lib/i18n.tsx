...
const translations = {
  en: {
    ...
    // The training plan's current week, on Today
    "home.planThisWeek": "Training plan",
    "home.planWeek": "Week {week}",
    "home.planOutstanding": "Left this week",
    "home.planRaces": "Training plans for {count} races",
    "home.planSessionsDone": "{done}/{total} done",
    "home.planSessionsSkipped": "{skipped} skipped",
    "home.planWeekSettled": "Every session this week is accounted for",
    "home.planWeekSettledBody": "Nothing outstanding. The next block week opens on Monday.",
    "home.planSeeWeek": "See the week",
    ...
    // Suggested weekly targets. The reasons are keys rather than sentences
    // because they are assembled from a plan week, a goal name and a count —
    // in an order that differs by language.
    "weeklySuggestion.heading": "Suggested for this week",
    "weeklySuggestion.emptyTitle": "Nothing set for this week",
    "weeklySuggestion.emptyBody": "These come from your race targets and your recent weeks. Use one as it is, or change the number.",
    "weeklySuggestion.use": "Use this",
    "weeklySuggestion.adjust": "Change",
    "weeklySuggestion.reason.planDistance": "Week {week} of your plan for {goal}",
    "weeklySuggestion.reason.planSessions": "Week {week} of your plan for {goal}",
    "weeklySuggestion.reason.targetDistance": "Building toward {goal}",
    "weeklySuggestion.reason.targetSessions": "Building toward {goal}",
    "weeklySuggestion.reason.historyDistance": "Your last {weeks} weeks averaged {km} km",
    "weeklySuggestion.reason.historyDistanceThin": "Only {weeks} weeks of runs so far — holding your level",
    "weeklySuggestion.reason.historySessions": "You have been running {sessions} times a week",
    "weeklySuggestion.reason.historySessionsThin": "Only {weeks} weeks of runs so far — holding your level",
    "weeklySuggestion.easedFor": "Eased for {goal}",
    "weeklySuggestion.dismiss": "Not this",
    "weeklySuggestion.adjustedFrom": "Adjusted from {value}",
    "weeklySuggestion.planSays": "Your plan says {value} for this week.",
    "weeklySuggestion.planMoved": "Your plan now says {value} for this week.",
    "weeklySuggestion.useNumber": "Use that",
    "weeklySuggestion.update": "Update",
    "weeklySuggestion.keepMine": "Keep mine",
    "weeklySuggestion.nextWeekTitle": "Next week, from your plan",
    "weeklySuggestion.nextWeekBody": "Your block already says what this week should hold. Take it now, or leave it until Monday.",
    "goals.events": "Events",
    ...
    "plan.supersedeTitle": "Put the other block away?",
    "plan.supersedeBody": "{names} still has {weeks}. One block at a time: two plans both build from the same training history, so following both means running roughly double what either asks for.",
    "plan.supersedeBodyPlural": "{names} still have time to run. One block at a time: two plans both build from the same training history, so following both means running roughly double what either asks for.",
    "plan.supersedeWeeks": "{count} week left",
    "plan.supersedeWeeksPlural": "{count} weeks left",
    "plan.supersedeConfirm": "Generate anyway",
    "plan.supersedeCancel": "Keep the current block",
    "plan.archivedTitle": "This block was put away",
    "plan.archivedBody": "It stopped being your training on {date}, when you generated a block for another race. It is kept here as history — generate again to make it your plan.",
    ...
    // Get started — the first-run checklist, as a sheet over the app
    "getStarted.title": "Get started",
    "getStarted.of": "of",
    "getStarted.completed": "done",
    "getStarted.hide": "Do not show again",
    "getStarted.hideHint": "You can reopen this list from Profile.",
    "getStarted.closeForNow": "Close for now",
    "getStarted.next": "Next",
    "getStarted.done": "Done",
    "getStarted.alreadyDone": "{done} of {total} already done.",
  ...
  no: {
    ...
    // Treningsplanens inneværende uke, på I dag
    "home.planThisWeek": "Treningsplan",
    "home.planWeek": "Uke {week}",
    "home.planOutstanding": "Igjen denne uken",
    "home.planRaces": "Treningsplaner for {count} løp",
    "home.planSessionsDone": "{done}/{total} gjort",
    "home.planSessionsSkipped": "{skipped} hoppet over",
    "home.planWeekSettled": "Alle øktene denne uken er gjort opp",
    "home.planWeekSettledBody": "Ingenting utestående. Neste uke i blokka åpner mandag.",
    "home.planSeeWeek": "Se uken",
    ...
    "weeklySuggestion.heading": "Forslag for denne uken",
    "weeklySuggestion.emptyTitle": "Ingenting satt for denne uken",
    "weeklySuggestion.emptyBody": "Disse kommer fra målene dine og de siste ukene du har løpt. Bruk et som det er, eller endre tallet.",
    "weeklySuggestion.use": "Bruk dette",
    "weeklySuggestion.adjust": "Endre",
    "weeklySuggestion.reason.planDistance": "Uke {week} i planen din for {goal}",
    "weeklySuggestion.reason.planSessions": "Uke {week} i planen din for {goal}",
    "weeklySuggestion.reason.targetDistance": "På vei mot {goal}",
    "weeklySuggestion.reason.targetSessions": "På vei mot {goal}",
    "weeklySuggestion.reason.historyDistance": "De siste {weeks} ukene har snittet {km} km",
    "weeklySuggestion.reason.historyDistanceThin": "Bare {weeks} uker med løping så langt — holder nivået ditt",
    "weeklySuggestion.reason.historySessions": "Du har løpt {sessions} ganger i uken",
    "weeklySuggestion.reason.historySessionsThin": "Bare {weeks} uker med løping så langt — holder nivået ditt",
    "weeklySuggestion.easedFor": "Lettet for {goal}",
    "weeklySuggestion.dismiss": "Ikke dette",
    "weeklySuggestion.adjustedFrom": "Justert fra {value}",
    "weeklySuggestion.planSays": "Planen din sier {value} for denne uken.",
    "weeklySuggestion.planMoved": "Planen din sier nå {value} for denne uken.",
    "weeklySuggestion.useNumber": "Bruk det",
    "weeklySuggestion.update": "Oppdater",
    "weeklySuggestion.keepMine": "Behold mitt",
    "weeklySuggestion.nextWeekTitle": "Neste uke, fra planen din",
    "weeklySuggestion.nextWeekBody": "Blokken din sier allerede hva denne uken skal inneholde. Ta den nå, eller vent til mandag.",
    "goals.events": "Løp",
    "goals.targets": "Mål",
    ...
    "plan.supersedeTitle": "Legge bort den andre blokka?",
    "plan.supersedeBody": "{names} har fortsatt {weeks}. Én blokk om gangen: to planer bygger begge fra den samme treningshistorikken, så følger du begge løper du omtrent det dobbelte av det hver av dem ber om.",
    "plan.supersedeBodyPlural": "{names} har fortsatt tid igjen å løpe. Én blokk om gangen: to planer bygger begge fra den samme treningshistorikken, så følger du begge løper du omtrent det dobbelte av det hver av dem ber om.",
    "plan.supersedeWeeks": "{count} uke igjen",
    "plan.supersedeWeeksPlural": "{count} uker igjen",
    "plan.supersedeConfirm": "Generer likevel",
    "plan.supersedeCancel": "Behold blokka jeg har",
    "plan.archivedTitle": "Denne blokka er lagt bort",
    "plan.archivedBody": "Den sluttet å være treningen din {date}, da du genererte en blokk for et annet løp. Den ligger her som historikk — generer på nytt for å gjøre den til planen din igjen.",
    ...
    "getStarted.hide": "Ikke vis igjen",
    "getStarted.hideHint": "Du kan hente fram lista igjen fra Profil.",
    "getStarted.closeForNow": "Lukk for nå",
    "getStarted.next": "Neste",
    "getStarted.done": "Ferdig",
    "getStarted.alreadyDone": "{done} av {total} er alt gjort.",
