...
const translations = {
  en: {
    ...
    "activities.newestFirst": "Newest first",
    "activities.oldestFirst": "Oldest first",
    "activities.longestFirst": "Longest first",
    "activities.shortestFirst": "Shortest first",
    "activities.fastestPace": "Fastest pace",
    "activities.slowestPace": "Slowest pace",
  ...
  no: {
    ...
    "activities.newestFirst": "Nyeste først",
    "activities.oldestFirst": "Eldste først",
    "activities.longestFirst": "Lengste først",
    "activities.shortestFirst": "Korteste først",
    "activities.fastestPace": "Raskeste tempo",
    "activities.slowestPace": "Langsomste tempo",
    "activities.pace": "Tempo",
    // Activity detail
